function [output_lower, output_upper, output_mean] = odemodel(x, u_mini_batch, learnable_parameters, number_mf, number_inputs, number_outputs, mbs, output_type, input_mf_type, input_type, type_reduction_method, u, alpha, delta, alpha_rev)
...
output_mean = permute(output_mean, [1 4 3 2]); %added dx
output_lower = permute(output_lower, [1 4 3 2]);%added dx_l
output_upper = permute(output_upper, [1 4 3 2]);%added dx_u
