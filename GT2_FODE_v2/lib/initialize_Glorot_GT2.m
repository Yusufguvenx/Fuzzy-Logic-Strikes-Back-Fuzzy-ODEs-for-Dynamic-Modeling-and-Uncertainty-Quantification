function [learnable_parameters, timesteps] = initialize_Glorot_GT2(input_data, output_data, input_type, output_type, number_mf, t, neuralOdeTimesteps)
...
for i = 1:size(input_data, 2)
    ...
    [~, centers(:, i)] = kmeans(data(:, i), number_mf, "MaxIter",100);
end
