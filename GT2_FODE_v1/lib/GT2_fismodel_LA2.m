function [output_lower, output_upper, output_mean] = GT2_fismodel_LA2(x, number_mf, number_inputs, number_outputs, mbs, learnable_parameters, output_type, input_mf_type, input_type,type_reduction_method,u,alpha, delta)
...
output_mean = cut(end).output_mean;
