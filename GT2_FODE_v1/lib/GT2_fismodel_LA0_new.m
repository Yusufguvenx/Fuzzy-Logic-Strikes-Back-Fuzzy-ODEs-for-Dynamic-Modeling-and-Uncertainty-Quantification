function [output_lower, output_upper, output_mean] = GT2_fismodel_LA0_new(x, number_mf, number_inputs, number_outputs, mbs, learnable_parameters, output_type, input_mf_type, input_type, type_reduction_method, u, alpha, delta, alpha_rev)
...
output_lower = pagemtimes(alpha_rev, output_lower);

output_upper = pagemtimes(alpha_rev, output_upper);
